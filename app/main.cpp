...
int main()
{
    ...
    // arena::MCSPlayer p1{g.getActionsCount(), n_sims, d, 1.0f, 1.0f};
    ...
    // arena::GravePlayer p1(g.getActionsCount(), n_sims, d, 15, 0.04f, true);
    ...
    arena::GravePlayer p2(g.getActionsCount(), n_sims, d, 15, 0.04f, true);
